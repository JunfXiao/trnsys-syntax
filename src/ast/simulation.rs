...
/// VERSION xx.x
#[derive(Debug, Clone, Constructor, From, Into, FromStr, Serialize, Deserialize)]
pub struct Version {
    pub version: String,
}
...
#[repr(u8)]
#[derive(
    Debug, Clone, Copy, PartialEq, Eq, FromRepr, EnumIter, Display, Default, Serialize, Deserialize,
)]
...
#[repr(u8)]
#[derive(Debug, Clone, Copy, FromRepr, EnumIter, Display, Default, Serialize, Deserialize)]
#[display("{} = {:?}", *self as u8, self)]
...
pub enum SolverMethod {
    ...
    #[deprecated(
        since = "0",
        note = "The Powell’s method solver has been deactivated in TRNSYS 18"
    )]
    Powell = 1,
}
